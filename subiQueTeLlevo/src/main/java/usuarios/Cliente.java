...
public class Cliente extends Usuario{
	...
	/**
	 * Verifica si se esta usando la aplicacion.
	 * 
	 * @return true si se esta usando la aplicacion, false en caso contrario.
	 */
	...
	/**
	 * Establece el estado de uso de la aplicacion.
	 * 
	 * @param usandoApp true para indicar que se esta usando la aplicacion, false en caso contrario.
	 */
